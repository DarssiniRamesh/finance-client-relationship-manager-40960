...
# PUBLIC_INTERFACE
@router.delete("/{client_id}", status_code=200, summary="Delete client")
def delete_client(client_id: int, db: Session = Depends(get_db), user: User = Depends(get_current_user)) -> dict:
