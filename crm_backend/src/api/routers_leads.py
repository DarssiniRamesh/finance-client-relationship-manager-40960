...
# PUBLIC_INTERFACE
@router.delete("/{lead_id}", status_code=200, summary="Delete lead")
def delete_lead(lead_id: int, db: Session = Depends(get_db), user: User = Depends(get_current_user)) -> dict:
    """Delete lead by id.
